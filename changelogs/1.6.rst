...
- NEMS Linux 1.6 Public Release to be announced, likely mid-late July/early August 2021.
...
- ``nems_sendmail_host`` and ``nems_sendmail_service`` now save state to ``/tmp/email_failure.tmp`` if the email failed to send.

...
NEMS <https://docs.nemslinux.com/en/latest/advanced/legacyupgrade.html>`__
...
that `nems-upgrade <https://docs.nemslinux.com/en/latest/commands/nems-upgrade.html>`__ is
an unknown program, did you initialize NEMS Linux? Please re-read
the `Initialization
Instructions <https://docs.nemslinux.com/en/latest/gettingstarted/initialization.html>`__ if that is the
case.

NEMS Linux 1.7 Changelogs (2024-2026)
========================================
...
After an incredible 2 year cycle, NEMS Linux 1.7 reached end of development July 21, 2026 to be superseded by NEMS Linux 1.8.
...
2026
^^^^
- [nems-plugins] An upstream bug in ``speed-cloudflare-cli`` was causing speedtest to fail. After waiting for upstream fix to occur, finally gave in and patched the code myself and made it part of ``nems-plugins`` instead of pulling from the seemingly dead project.
...
- [nems-migrator-data] Database has been upgraded to 10.11.6-MariaDB and sample database contains the now required InnoDB `ib_logfile0`.

...
- [New Feature] ``nems-kiosk`` allows you to enable graphical HDMI output on console / HDMI directly from your NEMS Server. Feature is found in NEMS SST under TV Display -> Console Output.

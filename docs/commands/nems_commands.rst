...
`nems-init <https://docs.nemslinux.com/commands/nems-init>`__ -
Initialize your NEMS Linux server.

`nems-mailtest <https://docs.nemslinux.com/commands/nems-mailtest>`__ -
Test the email notification settings of your NEMS Linux server.

`nems-quickfix <https://docs.nemslinux.com/commands/nems-quickfix>`__ -
Quickly run all rolling updates and bring in new patches and fixes with
one quick command.

`nems-restore <https://https://docs2.nemslinux.com/en/latest/commands/nems-restore.html >`__ -
...
`nems-upgrade <https://docs.nemslinux.com/commands/nems-upgrade>`__ -
Upgrade your NEMS Linux server to the latest point release.

`nems-support <https://docs.nemslinux.com/commands/nems-support>`__ -
...
`nems-migrator <https://docs.nemslinux.com/features/nems-migrator>`__ -
